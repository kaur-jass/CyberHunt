...
export default function ChallengeCard({
  ...
  const currentNode =
    nodeId || `ZDY-${routeCode?.toUpperCase() || 'A'}`;
  ...
  const handleSubmitFlag = async (e) => {
    ...
    try {
      ...
      setFeedback({
        ...
        message:
          data.message ||
          'Zero-day node verified. Final checkpoint unlocked.',
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex justify-between items-start border-b border-slate-200 pb-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-amber-700 font-mono text-xs font-semibold">
          ...
          <span className="px-2.5 py-1 text-[10px] font-mono uppercase tracking-wider bg-amber-50 border border-amber-200 rounded-md text-amber-700">
            {difficulty}
          </span>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-[10px] font-mono text-amber-700">
        ...
        <div className="space-y-3">
          ...
          <div className="text-xs font-mono uppercase tracking-wider text-amber-700 font-medium">
            {category}
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="border border-amber-200 rounded-lg p-3 bg-amber-50">
            ...
            <div className="flex items-center gap-2 text-[10px] font-mono uppercase text-amber-700">
            ...
            <div className="mt-1 text-xs font-mono text-amber-800">
              CRITICAL
            </div>
        ...
        <div className="flex gap-3 p-3 bg-slate-50 border border-slate-200 rounded-lg">
          ...
          <LockKeyhole className="w-4 h-4 text-slate-400 shrink-0 mt-0.5" />
          ...
          <div>
            ...
            <p className="text-xs text-slate-500 mt-1 leading-5">
              This challenge is isolated and intended only for the Cyber Hunt environment.
            </p>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    autoComplete="off"
                    className="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm font-mono bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-500 transition"
                  />
