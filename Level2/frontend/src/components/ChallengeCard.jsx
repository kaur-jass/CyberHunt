...
export default function ChallengeCard({
  ...
  const currentNode =
    nodeId || `BRH-${routeCode?.toUpperCase() || 'A'}`;
  ...
  const handleSubmitFlag = async (e) => {
    ...
    try {
      ...
      setFeedback({
        ...
        message:
          data.message ||
          'Breach verified. Next checkpoint unlocked.',
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="flex justify-between items-start border-b border-slate-200 pb-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex items-center gap-2 text-rose-700 font-mono text-xs font-semibold">
              <ShieldAlert className="w-4 h-4" />
              <span>BREACH / LEVEL 2</span>
            </div>
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5 text-[10px] font-mono text-rose-600">
        ...
        <div className="space-y-3">
          ...
          <div className="text-xs font-mono uppercase tracking-wider text-rose-700 font-medium">
            {category}
          </div>
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          <div className="border border-slate-200 rounded-lg p-3 bg-slate-50">
            ...
            <div className="mt-1 text-xs font-mono text-rose-700">
              RESTRICTED
            </div>
              ...
              >
                ...
                <div>
                  ...
                  <input
                    ...
                    autoComplete="off"
                    className="w-full px-3 py-2.5 border border-slate-200 rounded-lg text-sm font-mono bg-slate-50 text-slate-900 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-rose-500/20 focus:border-rose-500 transition"
                  />
